function rgb_out = create_2x4_block(blocks, colors, size)
...
for i=1:length(blocks)
    ...
    temp(1:2,2*size-3:2*size+3, :) = brighten(temp(1:2,2*size-3:2*size+3, :), bright);
    temp(2*size-1:2*size,2*size-3:2*size+3, :) = brighten(temp(2*size-1:2*size,2*size-3:2*size+3, :), dark);
